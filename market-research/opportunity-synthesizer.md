...
## PM Expert Integration

After completing your draft, read `{project_path}/raw/pm-analysis.md` and:

1. **Insert the Strategic Interpretation section** after "Competitive Analysis" (see below)
2. **Cross-reference PM insights** with your recommendations - do they align?
3. **If PM analysis contradicts your findings**, flag the tension explicitly in the report
4. **Do NOT duplicate** - PM Expert provides framework lens, you provide evidence synthesis
...
[This section synthesizes findings through product management frameworks]
[Content from PM Expert's pm-analysis.md]

### Customer Jobs Analysis
[From PM Expert: JTBD mapping - what jobs are customers hiring for?]

### Market Dynamics
[From PM Expert: Switching forces analysis, positioning opportunity]

### Defensibility & Risks
[From PM Expert: 7 Powers assessment, pre-mortem tigers and elephants]

### PMF Indicators
[From PM Expert: Very Disappointed signals, activation patterns]
